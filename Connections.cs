...
namespace Transport
{
    public sealed class Connections
    {
        ...
        string ConnectionString = @"Data Source=" + System.Configuration.ConfigurationSettings.AppSettings["Server"] + ";Initial Catalog=Transport;Integrated Security=True;";
        ...
        public void OpenConection()
        {
            if (App_Type == "Client")
            {
                ConnectionString = @"Data Source=" + System.Configuration.ConfigurationSettings.AppSettings["Server"] + ";Initial Catalog=Transport;User ID=sa;Password=" + System.Configuration.ConfigurationSettings.AppSettings["psd"];
            }
